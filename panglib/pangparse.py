...
tokens =  (
    ...
    (lookup("xxlarge"),   "<xxl>"               ),
    (lookup("exxlarge"),  "</xxl>"              ),
    (lookup("xxxlarge"),  "<xxxl>"              ),
    (lookup("exxxlarge"), "</xxxl>"             ),
    (lookup("small"),     "<sm>"                ),
    (lookup("esmall"),    "</sm>"               ),
    (lookup("xsmall"),    "<xs>"                ),
    (lookup("exsmall"),   "</xs>"               ),
...
class st():
    ...
    XXLARGE     = [unique(),    "xxlarge"]
    EXXLARGE    = [unique(),    "exxxlarge"]
    XXXLARGE    = [unique(),    "xxxlarge"]
    EXXXLARGE   = [unique(),    "exxlarge"]
    SMALL       = [unique(),    "small"]
...
parsetable = (
    ...
    ( None,    STATEFMT,  pl("xxxlarge"), None,   cb.Xxxlarge,  st.XXXLARGE, 0 ),
    ...
    ( st.XXXLARGE,    None,   None,       TXTCLASS,   cb.Text,         st.IGNORE, 0 ),
    ( st.XXXLARGE,    None,   pl("exxxlarge"), None,  cb.eXxxlarge,   st.IGNORE, 0 ),
